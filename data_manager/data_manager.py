...
# def get_pc_from_machining_file_backup(file_path):
#
...
def get_pc_from_machining_file(file_path):
    ...
    def onclick(event):
        ...
        # print(f'x = {ix}, y = {iy}, subplot row {event.inaxes.rowNum}, button {event.button}')
            ...
            if new_edges[header]['left_press_idx'] + new_edges[header]['right_press_idx'] > 0:
                ...
                if new_edges[header]['left_press_idx'] > 0:
                    if new_edges[header]['low_level_ini'] != -1 and new_edges[header]['low_level_end'] != -1:
                        ...
                        t = ax.text((new_edges[header]['low_level_end'] - new_edges[header]['low_level_ini']) / 2, (plt.axis()[3] - plt.axis()[2]) / 2, 'niveau bas', fontsize=1)
                        ...
                        t = ax.text(new_edges[header]['low_level_end'], (plt.axis()[3] - plt.axis()[2]) / 2, 'fin niveau bas', rotation='vertical')
                        edges[header]['plots'].append(t)

                    elif new_edges[header]['low_level_ini'] != -1 and new_edges[header]['low_level_end'] == -1:
                        ax.axvline(x=new_edges[header]['low_level_ini'], color='g')
                        t = ax.text(new_edges[header]['low_level_ini'], (plt.axis()[3] - plt.axis()[2]) / 2, 'début niveau bas', rotation='vertical')
                        edges[header]['plots'].append(t)
                ...
                if new_edges[header]['right_press_idx'] > 0:
                    if new_edges[header]['high_level_ini'] != -1 and new_edges[header]['high_level_end'] != -1:
                        ...
                        t = ax.text((new_edges[header]['high_level_end'] - new_edges[header]['high_level_ini']) / 2, (plt.axis()[3] - plt.axis()[2]) / 2, 'niveau bas', fontsize=1)
                        edges[header]['plots'].append(t)
                        ...
                        t = ax.text(new_edges[header]['high_level_end'], (plt.axis()[3] - plt.axis()[2]) / 2, 'fin niveau haut', rotation='vertical')
                        edges[header]['plots'].append(t)

                    elif new_edges[header]['high_level_ini'] != -1 and new_edges[header]['high_level_end'] == -1:
                        ax.axvline(x=new_edges[header]['high_level_ini'], color='r')
                        t = ax.text(new_edges[header]['high_level_ini'], (plt.axis()[3] - plt.axis()[2]) / 2, 'début niveau haut', rotation='vertical')
                        edges[header]['plots'].append(t)
